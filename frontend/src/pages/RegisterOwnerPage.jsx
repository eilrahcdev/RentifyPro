...
import { ChevronLeft, Eye, EyeOff, Upload, ShieldCheck } from "lucide-react";
...
=======
  ...
  const documentConfig =
    form.ownerType === "business"
      ? [
          { key: "governmentId", label: "Government ID", helper: "National ID, Passport, etc." },
          { key: "driversLicense", label: "Driver’s License", helper: "Valid driver's license" },
          { key: "businessPermit", label: "Business Permit", helper: "DTI / SEC / Mayor’s Permit" },
        ]
      : [
          { key: "governmentId", label: "Government ID", helper: "National ID, Passport, etc." },
          { key: "driversLicense", label: "Driver’s License", helper: "Valid driver's license" },
