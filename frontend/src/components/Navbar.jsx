...
import { MessageCircle, Bell, Bot, Settings, Car, X } from "lucide-react";
...
<<<<<<< HEAD
=======
          <button onClick={onLogout} className="w-full px-4 py-3 text-red-500 hover:bg-red-50 transition-colors duration-300">
            ⎋ Sign Out
=======
  const [unreadMessages, setUnreadMessages] = useState(0);
  const [unreadNotifications, setUnreadNotifications] = useState(0);
